...
No-review red→green-acceptance runs with instrumentation on, current ("old")
implementation:
...
Record the baseline time-budget table in the framework-speedup README. The
"new implementation" runs repeat on the same fixtures after Tasks 9–12 land.
