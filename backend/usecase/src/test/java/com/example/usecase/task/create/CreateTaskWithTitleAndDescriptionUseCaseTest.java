...
class CreateTaskWithTitleAndDescriptionUseCaseTest extends ApplicationTest {
    ...
    void should_create_task_with_title_and_description() {
        taskStatements.createTaskWithTitleAndDescription("Set up CI/CD", "Configure GitHub Actions");
